...
mirror="rsync -ri --ignore-existing --exclude-from=/mnt/user/appdata/romSync/exclude.txt"
...
roms() {
  ...
  then
    ...
    $mirror $unraid_games/roms/mastersystem/ root@$mister:$mister_sd/games/SMS/mastersystem/
    ...
    $mirror $unraid_games/roms/pc/ root@$mister:$mister_sd/games/AO486/
